...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300 font-sans text-slate-900 dark:text-slate-50 flex flex-col justify-between">
      ...
      <footer className="w-full border-t border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-950/50 backdrop-blur-xl py-6 mt-10 pb-24 md:pb-6 text-center text-xs text-slate-500 font-medium">
